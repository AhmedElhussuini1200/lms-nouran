...
// ملف الدعم الجديد (brand + grades + youtube) — require صريح عشان يشتغل
// حتى لو عملية السيرفر القديمة محملة قايمة autoload قبل إضافته
require_once __DIR__ . '/../../Support/lms.php';

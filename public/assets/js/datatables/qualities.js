    ...
    var initDatatable = function () {
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        const fileUrl = `/storage/qualities/${row.upload}`;
                        return `
        ...
        `;
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function (data, type, row) {
                        // زر الموافقة يظهر فقط إذا الصف غير معتمد والدور admin أو amana
                        let approveHtml = "";
                        if (
                            !row.is_approved &&
        ...
        $("#kt_datatable").on("click", ".approve-btn", function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    toastr.success("Contract item approved successfully");
                },
                error: function (err) {
                    console.error(err);
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                $("#form_title").text(__("Edit Quality"));
                $("#title_inp").val(data.title).trigger("change");
                $("#description_inp").val(data.description).trigger("change");
                if (data.upload) {
                    $("#current_file").html(`
        <a href="/storage/qualities/${data.upload}" target="_blank" class="text-primary">

...
return [
    ...
    */
    ...
    'boolean' => 'يجب أن تكون قيمة ( :attribute ) إما صحيحة أو false ',
    ...
    'start_contract_date' => 'حقل (:start_contract_date) العقد مطلوب',
    'tax_number' => '(:attribute ) حقل ',
    'name_ar' => '(:attribute)',
    'name_en' => '(:attribute)',
    'quantity' => '(:attribute)',
    'contract_number'=>'(:attribute)',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'custom' => [
        ...
        [
            'start_contract_date' => [
                'in' => 'حقل تاريخ بداية العقد مطلوب'
            ]
        ],
        [
            'tax_number' => [
                'in' => 'حقل رقم الضربية مطلوب '
            ]

        ],
        [
            'name_ar' => [
                'in' => 'حقل الاسم باللغة العربية مطلوب'
            ]
        ...
        [
            'name_en' => [
                'in' => 'حقل الاسم باللغة الانجليزية مطلوب'
            ]
    ...
    */
    ...
    'attributes' => [
        ...
        'district_id' => 'المنطقة',
        'tax_number' => 'رقم الضربية ',
        "action_id" => "الاجراء المقترح",
        "required_action_id" => "الاجراء المطلوب",
        'message' => 'الرسالة',
        'email' => 'البريد الإلكتروني',
        'phone' => 'الهاتف',
        'result' => 'النتيجة',
        "proposed_budget" => "الميزانية المقترحة",
        "expected_completion_date" => "تاريخ الانتهاء المتوقع",
        "causes" => 'السبب',
        "AssignEmployee" => "تعيين موظف",
        "WithDrawRequest" => "طلب صرف",
        ...
        'name' => 'الأسم',
        "location_lat" => "خط الطول",
        "location_long" => "خط العرض",
        "is_completed" => "رمز ال QR",
        "execution_action_id" => 'الاجراء المنفذ',
        "is_completed" => "هل اكتملت المهمة",
        ...
        "warning_icon" => "رقم العامود",
        "notes" => "الملاحظات",
        'address' => 'العنوان',
        'city_id' => 'المدينة',
        'new_assign' => 'تعيين جديد',
        "location_data" => "بيانات المواقع",
        'roles' => 'الصلاحيات والادوار',
        'established_at' => "تاريخ تشغيل المحطة ",
        'last_maintenance' => "تاريخ أخر صيانة",
        ...
        'start_contract_date' => 'تاريخ بداية العقد',
        'end_contract_date' => 'تاريخ نهاية العقد',
        ...
        'sectors_id' => 'القطاع',
        'reporting_to_id' => 'المدير المسئول',
        ...
        "start_price" => "السعر الإفتتاحي",
        "bid_price" => "سعر المزايدة",
        "ticket_price" => "سعر التذكرة",
        "variations" => "",
        "certificates.*.name" => "اسم الشهادة",
        "certificates.*.files" => "صورة الشهادة",
        "certificates.*.expiration_date" => "تاريخ انتهاء الشهادة",
        "certificates.*.have_expiration_date" => "لا تنتهي الشهادة",
        "license.*.name" => "اسم الرخصة",
        "license.*.files" => "صورة الرخصة",
        "license.*.expiration_date" => "تاريخ انتهاء الرخصة",
        "license.*.have_expiration_date" => "لا تنتهي الرخصة",
        "owner_commission" => "عمولة المالك",
        "owner_commission_type" => "نوع عمولة المالك",
        "vendor_commission" => "عمولة المحترف",
        "vendor_commission_type" => "نوع عمولة المحترف",
        "tax" => "الضريبة",
        "max_cancellations" => "الحد الأقصى للإلغاءات",
        "penalty_amount" => "مبلغ العقوبة",
        "owner_commition_percentage" => "نسبة الضريبة القيمة المضافة للعقد",
        "vendor_commition_percentage" => "نسبة عمولة المحترف",
        "owner_commition_fixed" => "عمولة المالك ثابتة",
        "vendor_commition_fixed" => "عمولة المحترف ثابتة",
        "from_to_datep" => "نطاق التاريخ",
        "total" => "المجموع",
        "Invalid discount type selected" => "نوع الخصم المحدد غير صالح",
        "Invalid promo code" => "كود الترويج غير صالح",
        "Invalid applicable option" => "الخيار المحدد غير صالح",
        "Invalid expiration type" => "نوع انتهاء الصلاحية غير صالح",
        "Invalid discount value" => "قيمة الخصم غير صالحة",
        "The start date must be today or in the future" => "يجب أن يكون تاريخ البدء هو اليوم أو في المستقبل",
        "The expiration date must be after the start date" => "يجب أن يكون تاريخ انتهاء الصلاحية بعد تاريخ البدء",
        "Usage limit must be at least 0" => "يجب أن يكون حد الاستخدام 0 على الأقل",
        "Invalid status value" => "قيمة الحالة غير صالحة",
        "address_en" => "العنوان بالانجليزية",
        "address_ar" => "العنوان بالعربية",
        "promo_applicable_to_id" => "الرمز الترويجي ينطبق علي",
        "promo_code_type_id" => "نوع الرمز الترويجي",
        "value" => "قيمة الرمز ",
        "starts_promo" => "تاريخ بدأ الرمز",
        "expires_at" => "تاريخ انتهاء الرمز ",
        "usage_limit" => "عدد مرات استخدام الرمز",
        "is_active" => " حالة الرمز",
        "ios_min_supported_version" => "الحد الأدنى لإصدار iOS المدعوم",
        "android_min_supported_version" => "الحد الأدنى لإصدار Android المدعوم",
        "ios_exact_blocked_version" => "الإصدار المحظور بالضبط لنظام iOS",
        "android_exact_blocked_version" => "الإصدار المحظور بالضبط لنظام Android",
        "android_maintenance_message" => "رسالة صيانة Android",
        "ios_maintenance_message" => "رسالة صيانة iOS",
        "android_maintenance_mode" => "وضع صيانة Android",
        "stamp" => "الختم",
        "signature" => "التوقيع",
        "upload" => "ملف المستخلص ",

        "neighborhood_id" => "  اسم الحي",
        'stamp' => ' الختم ',
        'logo' => 'الشعار  ',
        'tax_number' => '  رقم الضريبة',
        'email' => '   البريد الإلكتروني',
        'city_id' => '  اسم المدينة',
        'district_id' => '  اسم المنطقة',
        'sector_id' => '  اسم القطاع',
        'manager_id' => 'المدير ',
        'competition_number' => 'رقم المنافسة للعقد ',
        'item_description.*' => 'بيان الاعمال ',
        'unit_id.*' => 'الوحدة ',
        'quantity.*' => 'الكمية ',
        'unit_price.*' => 'السعر الوحدة  عددا   ',
        'unit_price_text.*' => 'السعر الوحدة كتابا  ',
        'total_price.*' => 'السعر الكلي عددا  ',
        'total_unit_price_text.*' => 'السعر الكلي كتابا  ',
        'contract_id' => 'العقد للبنود  ',
        'action_id' => 'الاجراء ',
        'feeder' => 'الفيدر / العمود ',
        'quantity' => 'الكمية ',
        'unit_id' => 'الوحدة ',
        'warehouse_id' => 'المستودع  ',
        'lights_count' => 'عدد الفوانيس ',
        'plate_number' => 'رقم اللوحة  ',
        'cable_number' => 'ارتفاع العمود',
        'column_number' => 'ارتفاع العمود',
        'lights_count' => 'عدد الفوانيس ',
        'complaint_type_id' => 'نوع البلاغ',
        'extinguish_type_id' => 'نوع الاطفاء',
        'report_time' => 'تاريخ البلاغ',
        'complaint_type_id' => 'نوع البلاغ',
        'response_duration' => 'المدة المباشرة ',
        'feeder' => 'الفيدر ',
        'report_number' => 'رقم التفرير  ',
        'light_columns_id'=>'العمود ',
        'priority_id'=>'الاولولية',
        'contract_year'=>'سنة العقد',
        'contract_number'=>'رقم العقد',
        'total_amount'=>'اجمالي المبلغ للعقد',

...
var KTDatatablesServerSide = (function () {
            ...
            columnDefs: [
                        ...
                        return `
                           <div>
                                ...
                                <div class="d-flex flex-column justify-content-center" >
                                    <span class="mb-1 text-gray-600" >${data}</span>
                                </div>
                                <!--end::Info-->
                            </div>
                        `;
                ...
                },
                {
                    ...
                    render: function (data) {
                        let status = statusLabels[data];
                        return `<span class="badge badge-light-${status.color}">${status.title}</span>`;
                    },
                },
                {
                    targets: 5,
                    render: function (data, type, row) {
                        return `
                            <div>
                                <!--begin::Info-->
                                <div class="d-flex flex-column justify-content-center">
                                    <span class="mb-1 text-gray-600">${row.created_at}</span>
                                </div>
                                <!--end::Info-->
                            </div>
                        `;
                        ...
                        <div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/admin/${prefix}/${dbTable}/${
                            data.id
                                ...
                                ${
                                    data.status === 1
                                        ? `<!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="javascript:;" class="menu-link px-3" data-kt-docs-table-filter="status_row">
                                            ${__("Inactive")}
                                        </a>
                                    </div>
                                    <!--end::Menu item-->`
    ...
    var handleBlockingRows = () => {
        ...
        const blockingButtons = document.querySelectorAll(
            '[data-kt-docs-table-filter="status_row"]'
        );
        ...
        blockingButtons.forEach((d) => {
            ...
            d.addEventListener("click", function (e) {
                ...
                $.ajax({
                    type: "get",
                    url: `/dashboard/admin/${prefix}/${dbTable}/status/${data.id}`,
                    data: {
                        status: data.status,
                    },
                    success: function () {
                        datatable.draw();
                        if (data.status === 1) {
                            successAlert(`${__("InActive successfully")} `);
                        } else {
                            successAlert(`${__("Active successfully")} `);
                        }
                    },
                    error: function (err) {

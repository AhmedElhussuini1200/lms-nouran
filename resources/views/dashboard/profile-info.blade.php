            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    <form id="kt_account_profile_details_form" class="ajax-form" method="POST"
                        action="{{ route('admin.admins.update-profile-info') }}">
                        @csrf
                        @method('PUT')
                        <!--begin::Card body-->
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                                ...
                                <form id="kt_signin_change_email" class="ajax-form" method="POST"
                                    action="{{ route('admin.admins.update-profile-email') }}" novalidate="novalidate">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-6">
                                    ...
                                    <div class="d-flex">
                                        <button type="submit"
                                            class="btn btn-primary me-2 px-6">{{ __('Update Email') }}</button>
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-10">
                            ...
                            <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                ...
                                <form id="kt_signin_change_password" class="ajax-form" method="POST"
                                    action="{{ route('admin.admins.update-profile-password') }}" novalidate="novalidate">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-1">
                                        <div class="col-lg-4">
                                    ...
                                    <div class="d-flex">
                                        <button type="submit"
                                            class="btn btn-primary me-2 px-6">{{ __('Update Password') }}</button>

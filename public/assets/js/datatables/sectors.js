        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                url: `/dashboard/${prefix}/${dbTable}`,
                 data: function (d) {
                    d.neighborhood_id = $("#type_filter").val();
                    ...
                    render: function (data, type, row) {
                        return `
                            <div>
                                <!--begin::Info-->
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="javascript:;" class="mb-1 text-gray-800 text-hover-primary">${__(row.neighborhood.name)}</a>
                                </div>
                                <!--end::Info-->
                            </div>
                        `;

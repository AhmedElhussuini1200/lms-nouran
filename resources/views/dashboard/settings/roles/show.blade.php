                        ...
                        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                            ...
                            @forelse ($admins as $admin)
                                ...
                                <div class="d-flex align-items-sm-center justify-content-between mb-7 px-10">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="me-5 position-relative">
                                                ...
                                                <div class="symbol symbol-35px symbol-circle">
                                                    <img alt="Pic"
                                                        src="{{ getImagePathFromDirectory($admin->image, 'Employees') }}">
                                                </div>
                                                <!--end::Avatar-->
                                            </div>
                                            <!--end::Wrapper-->
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                <span
                                                    class="mb-1 text-gray-800 text-hover-primary">{{ $admin->name }}</span>
                                    ...
                                    <!--begin::Content-->
                                    <div class="">
                                        <a href="mail_to:{{ $admin->email }}"
                                            class="text-gray-800 fw-bold text-hover-primary fs-6">{{ $admin->email }}</a>
                                    </div>
                                    <!--end::Content-->
                                    <!--begin::Content-->
                                    <div class="">

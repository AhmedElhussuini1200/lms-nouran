...
var KTDatatablesServerSide = (function () {
    let dbTable = "LightColumns";
    let prefix = "admin";
    // dashboard/admin/LightColumns/
    // Private functions
                        ...
                        return `
                            <div>
                                ...
                                <div class="d-flex flex-column justify-content-center">
                                    <a href="javascript:;" class="mb-1 text-gray-800 text-hover-primary">${row.column_number}</a>
                                </div>
                                <!--end::Info-->
                            </div>
                        `;
            ...
            <div>
                ...
                <div class="d-flex flex-column justify-content-center">
                    <a href="javascript:;" class="mb-1 text-gray-800 text-hover-primary">
                        ${row.station ? row.station.name_ar : "--"}
                    </a>
                </div>
                <!--end::Info-->
            </div>
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach((d) => {
            ...
            d.addEventListener("click", function (e) {
                ...
                $("#form_title").text(__("Edit LightColumn"));
                $("#column_number_inp").val(data.column_number);
                $("#cable_number_inp").val(data.cable_number);
                $("#plate_number_inp").val(data.plate_number);
                $("#lights_count_inp").val(data.lights_count);

<!DOCTYPE html>
<html
    @if (!isArabic()) lang="en" direction="ltr" style="direction:ltr" @else lang="ar" direction="rtl"
                    ...
                    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                        ...
                        <div class="d-flex flex-column flex-column-fluid">
                            ...
                            {{-- <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                                        <!--begin::Page title-->
                                        <div
                                            class="page-title d-flex flex-column justify-content-center gap-1 me-3 ms-1">
                                            @yield('breadcrumbs')
                                        </div>
                                        <!--end::Page title-->
                                    </div> --}}
    ...
    <div class="position-fixed bottom-0 start-0 p-3 " style="z-index: 1090">
        <div id="kt_docs_toast_toggle" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <img src="{{ asset('placeholder_images/apple-touch-icon.png') }}" class="me-2 theme-light-show"
                    width="20" srcset="">
                <img src="{{ asset('placeholder_images/apple-touch-icon.png') }}" class="me-2 theme-dark-show"
                    width="20" srcset="">

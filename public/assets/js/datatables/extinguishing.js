...
var KTDatatablesServerSide = (function () {
    let dbTable = "extinguishes"; // changed from 'cities' to 'complaint_types'
    let prefix = "admin";
    // Private functions
    var initDatatable = function () {
                ...
                },
     {
                    ...
                    render: function (data, type, row) {
                        return `<div class="d-flex flex-column justify-content-center">
                                    <a href="javascript:;" class="mb-1 text-gray-800 text-hover-primary">${row.complainttype.name_ar}</a>
                                </div>`;
                    },
                },
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                $("#form_title").text(__("Edit extinguishing Types"));
                $("#name_ar_inp").val(data.name_ar);
                $('#complaint_type_id_inp').val(data.complaint_type_id).trigger("change");

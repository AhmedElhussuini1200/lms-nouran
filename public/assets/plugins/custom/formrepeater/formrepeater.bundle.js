...
(function ($) {
    ...
    var buildFormInputs = function (fig) {
        ...
        if ($self.is("input, select, textarea")) {
            ...
            addInputsBasic("email", 'input[type="text"]');
            ...
            $items.each(function (index) {
                ...
                $filterNested($item.find("[name]"), repeaters).each(
                    function () {
                        ...
                        var newId =
                            groupName + "_" + index + "_" + name + "_inp";
                        $input.attr("id", newId);
                    }
                );

                $filterNested($item.find(".invalid-feedback"), repeaters).each(
                    function () {
                        ...
                        var newErrorId =
                            ...
                            index +
                            "_" +
                            currentId.replace(/^[^\_]*\_\d+_/, ""); // Remove existing groupName prefix

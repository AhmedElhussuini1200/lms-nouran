    ...
    var initDatatable = function () {
        datatable = $("#kt_datatable").DataTable({
            ...
            columns: [
                ...
                // { data: "type" }, // Arabic name
                { data: "tax_number" }, // Tax number
                { data: "address" }, // Address
                { data: "email" }, // Email
                { data: "city.name" }, // City name (join)
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                            <div>
                                ${row.name}
                                <div class="fw-semibold fs-6 text-gray-400">${__(
                                    row.type ?? "--"
                                )}</div>
                            </div>
                        `;
    ...
    var handleEditRows = () => {
        ...
        editButtons.forEach((d) => {
            d.addEventListener("click", function (e) {
                ...
                //     .css("background-image", `url('${data.full_stamp_path}')`);

//           $("#logo_inp .image-input").find(".image-input-wrapper").css(
//     "background-image",
//     `url('${data.full_logo_path}')`
// );
    $('.image-input-wrapper').css('background-image', `url('${data.full_logo_path}')`);
                ...
                //     .closest(".image-input")
                //     .find(".image-input-wrapper")
                //     .css("background-image", `url('${data.full_logo_path}')`);
// console.log(data);

...
var KTCreateAccount = (function () {
    ...
    var validateStep = function (step, stepper) {
        let formData = new FormData(
            document.getElementById("kt_create_account_form")
        );
        console.log(step);
        UIBlocker.block();
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (currentStep == LAST_STEP) submitFormByAjax();
                else {
                    console.log("error");
                    UIBlocker.release();
                    stepper.goNext();
    ...
    var handleForm = function () {
        formSubmitButton.addEventListener("click", function (e) {
            validateStep(
                stepperObj.getCurrentStepIndex() - 1,
                stepperObj,
                true
            );
        });
    ...
    var submitFormByAjax = function () {
        ...
        ajaxSubmission({
            ...
            successCallback: function (response) {
                ...
                setTimeout(function () {
                    window.location = "/dashboard/admin/products";
                }, 1000);
            },
        ...
        $(".restore-item").on("click", function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    setTimeout(function () {
                        window.location = "/dashboard/admin/doctors";
                    }, 1000);
                },
            });
        });
    ...
    return {
        ...
        init: function () {
            ...
            formPreviousButton = stepper.querySelector(

@extends('dashboard.admin.partials.master')
@push('styles')
    <link href="{{ asset('assets/dashboard/admin/css/datatables' . (isDarkMode() ? '.dark' : '') . '.bundle.css') }}"
        rel="stylesheet" type="text/css" />
    <link
        href="{{ asset('assets/dashboard/admin/plugins/custom/datatables/datatables.bundle' . (isArabic() ? '.rtl' : '') . '.css') }}"
        rel="stylesheet" type="text/css" />
    <style>
        .headerIcons {
            font-size: 1.5rem;
...
@push('scripts')
    <script>
        ...
        let lightboxPath = "{{ asset('assets/dashboard/admin/plugins/custom/fslightbox/fslightbox.bundle.js') }}";
        ...
        // /dashboard/admin/trash/${modelName}/${ row.id }
    ...
    <script src="{{ asset('assets/dashboard/admin/js/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('assets/dashboard/admin/js/datatables/trash.js') }}"></script>
@endpush
